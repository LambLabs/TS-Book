...
\begin{equation}
f(t) = \begin{cases}
0 & \TT{\text{ dla }}{\text{ if }} t \in \left(-\infty; -frac{\tau}{2}\right)\\
A & \TT{\text{ dla }}{\text{ if }} t \in \left(-frac{\tau}{2}; frac{\tau}{2}\right)\\
0 & \TT{\text{ dla }}{\text{ if }} t \in \left(frac{\tau}{2}; \infty\right)\\
\end{cases}
\end{equation}
