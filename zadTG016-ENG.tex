\begin{task}
\TT{Oblicz moc i wartość skuteczną sygnału okresowego $f(t)$ przedstawionego na rysunku }{Calculate the average power and the effective value (RMS) for the periodic signal given below}
...
\TT{Drugi odcinek funkcji jest prostą przechodzącą przez następujące dwa punkty: $(3,0)$ oraz $(6,-A)$. Możemy więc napisać układ równań, rozwiązać go i znaleźć nieznane parametry $m$ i $b$.}{In the second interval of the first period (e.g. $t \in (3; 6)$), linear function crosses other two points:: $(3,0)$ oraz $(6,-A)$. So, in order to derive $m$ i $b$, the following system of the equations has to be solved.}
