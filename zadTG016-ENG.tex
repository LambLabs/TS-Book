...
In the first interval of the first period (e.g. $t \in (0; 3)$), linear function crosses two points: $(0,0)$ and $(3,A)$. So, in order to derive $m$ and $b$, the following system of the equations has to be solved.  
