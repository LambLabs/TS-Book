...
\TT{Transformata Fouriera sygnału $f(t)=Sa^2\left(\frac{t-t_0}{T}\right) \cdot cos\left(\omega_0 \cdot t\right)$ jest równa}{The Fourier transform of $f(t)=Sa^2\left(\omega_0 \cdot t\right) \cdot cos\left(\omega_0 \cdot t\right)$ is equal to}
