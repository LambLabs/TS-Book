...
\begin{equation}
f(t) = A \cdot \Lambda(\frac{t}{t_{0}}) = \begin{cases}
0 & \TT{\text{ dla }}{\text{ for }} t \in \left(-\infty; -t_{0}\right)\\
\frac{A}{t_{0}} \cdot t + A & \TT{\text{ dla }}{\text{ for }} t \in \left(-t_{0}; 0\right)\\
-\frac{A}{t_{0}} \cdot t + A & \TT{\text{ dla }}{\text{ for }} t \in \left(0; t_{0}\right)\\
