...
\fi
\if 2\booklanguageh%
  \def\booktitle{Signal Theory in Examples}
\fi
...
\TT{\chapter{Podstawowe własności sygnałów}}{\chapter{Basic properties of the signals}}
...
\TT{\section{Podstawowe własności sygnałów}}{\section{Basic properties of the signals}}
%	Basic signal metrics
%		Amplitude
%		Mean value
\TT{\subsection{Wartość średnia}}{\subsection{Mean of the signal}}
...
%		Energy of a signal
\TT{\subsection{Energia sygnału}}{\subsection{Energy of the signal}}
\inputTask{zadKW006-ENG.tex}
%		Power of s signal
\TT{\subsection{Moc sygnału}}{\subsection{Power of the signal}}
...
\TT{\chapter{Analiza sygnałów okresowych za pomocą szeregów ortogonalnych}}{\chapter{Analisis of the periodic signals by ortogonal series}}
%	Hilbert space
%	Orthogonal bases
...
\inputTask{zadTG018-ENG.tex} %To samo zadanie co KW44 tylko inaczej wyliczone
\inputTask{zadKW044-ENG.tex} %To samo zadanie co TG18 tylko inaczej wyliczone
%	The influence of signal symmetries on the coefficients of the trigonometric Fourier series
%	Complex exponential Fourier series
\TT{\section{Zespolony szerego Fouriera}}{\section{Complex Fourier Series}}
\inputTask{zadKW012-ENG.tex}
\inputTask{zadKW013-ENG.tex}
\inputTask{zadKW014-ENG.tex}
\inputTask[Debug]{zadKW015-ENG.tex}
\inputTask{zadKW018.tex}
\inputTask{zadKW042.tex} %ZŁE rozwiązania
\inputTask{zadKW043.tex} %ZŁE rozwiązania
...
\TT{\section{Obliczenia mocy sygnałów - twierdzenie Parsevala}}{\section{Calculation of the signals power - Perseval's teorem}}
\inputTask{zadTG014.tex}
%Analysis of non-periodic signals. Fourier Transformation and Transform
\TT{\chapter{Analiza sygnałów nieokresowych. Transformata Fouriera}}{\chapter{Non-periodic signals analisis - Fourier Transform}}
%	An intuitive introduction
%	Definition
\TT{\section{Wyznaczanie transformaty Fouriera z definicji}}{\section{Calculation of Fourier Transform from definition}}
...
%		Integration theorem
\TT{\section{Wykorzystanie twierdzeń do obliczeń transformaty Fouriera}}{\section{Exploiting properties of the Fourier transform}}
...
\TT{\section{Obliczenia energii sygnału za pomocą transformaty Fouriera. Twierdzenie Parsevala}}{\section{Signal power calculation based on Fourier transform. Perseval Teorem}}
...
\TT{\chapter{Przetwarzanie sygnałów za pomocą układów LTI}}{\chapter{Linear Time Invariant}}
...
\TT{\section{Obliczanie splotu ze wzoru}}{\section{Convolutions}}
