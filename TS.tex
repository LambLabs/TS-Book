...
\inputTask[Debug]{zadKW030.tex} % "|\/|" - linearity, scaling
\inputTask[Debug]{zadKW031.tex} % stairs - linearity, scaling, shift in time
\inputTask[Debug]{zadKW024.tex} % Sa*sin - modulation, duality, linearity
\inputTask[Debug]{zadKW025.tex} % Sa^2*cos - modulation, duality, linearity
\inputTask[Debug]{zadKW027.tex} %(1/(1-t^2)) - duality, by definition
\inputTask[Debug]{zadTG005.tex} % triangle - intergate x1, linearity, scaling, shift in time
\inputTask[Debug]{zadTG006.tex} % triangle - intergate x2, linearity, Dirac sampling
\inputTask[Debug]{zadKW021.tex} % gate - intergate x1, linearity, Dirac sampling
\inputTask[Debug]{zadKW022.tex} % ramp - intergate x1, linearity, scaling, Dirac sampling
\inputTask[Debug]{zadKW023.tex} % slope - intergate x1, linearity, Dirac sampling
\inputTask[Debug]{zadTG007.tex} % 1-t^2 - integrate x2, linearity, Dirac sampling

\inputTask[Debug]{zadKW026.tex} %sgn - integration x1, linaerity, Dirac sampling
