...
\inputTask[Debug]{zadKW030-ENG.tex} % "|\/|" - linearity, scaling
\inputTask{zadKW031.tex} % stairs - linearity, scaling, shift in time
\inputTask{zadKW024.tex} % Sa*sin - modulation, duality, linearity
\inputTask{zadKW025.tex} % Sa^2*cos - modulation, duality, linearity
\inputTask{zadKW027.tex} %(1/(1-t^2)) - duality, by definition
\inputTask{zadTG005.tex} % triangle - intergate x1, linearity, scaling, shift in time
\inputTask{zadTG006.tex} % triangle - intergate x2, linearity, Dirac sampling
...
\inputTask{zadTG007.tex} % 1-t^2 - integrate x2, linearity, Dirac sampling

\inputTask{zadKW026.tex} %sgn - integration x1, linaerity, Dirac sampling
