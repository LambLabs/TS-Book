...
\inputTask{zadKW048-ENG.tex} % do rozwiązania jeszcze - tylko przesunięcie
...
\inputTask{zadKW047.tex} % do rozwiązania jeszcze
...
\inputTask[Debug]{zadKW049.tex} %Wyznaczenie wartości średniej ze znanej mocy
\inputTask[Debug]{zadKW050.tex} %Wyznaczenie stosunku parzystych harmonicznych do nieparzystych
...
\inputTask[Debug]{zadKW051.tex} %Jeszcze nie poprawne widmo fazowe
...
\inputTask[Debug]{zadKW052.tex} % Sa*cos^2 modulation - TODO
\inputTask[Debug]{zadKW053.tex} % Pi*cos^2 modulation
...
\inputTask{zadKW025-ENG.tex} % Sa^2*cos - modulation, duality, scaling, linearity - sprawdzić poprawność
...
\inputTask[Debug]{zadTG008.tex}
\inputTask[Debug]{zadKW028.tex}
%	Frequency response
