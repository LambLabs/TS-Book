...
\subsection{Podstawowe własności sygnałów}
%	Basic signal metrics
%		Amplitude
%		Mean value
\subsubsection{Wartość średnia}
\inputTask{zadKW001.tex}
\inputTask{zadKW002.tex}
\inputTask{zadKW007.tex}
%		Energy of a signal
\subsubsection{Energia sygnału}
\inputTask{zadKW006.tex}
%		Power of s signal
\subsubsection{Moc sygnału}
\inputTask{zadKW016.tex}
\inputTask{zadKW004.tex}
\inputTask{zadKW003.tex}
\inputTask{zadKW005.tex} %ToDo na energię
\inputTask{zadKW017.tex} %ToDo na energię
...
\section{Analiza sygnałów okresowych za pomocą szeregów ortogonalnych}
%	Hilbert space
%	Orthogonal bases
%	Orthogonal series of functions
%	Trigonometric Fourier series
\subsection{Trygonometryczny szerego Fouriera}
...
\subsection{Zespolony szerego Fouriera}
...
\subsection{Obliczenia mocy sygnałów - twierdzenie Parsevala}
\inputTask{zadTG014.tex}
%Analysis of non-periodic signals. Fourier Transformation and Transform
\section{Analiza sygnałów nieokresowych. Transformata Fouriera}
%	An intuitive introduction
%	Definition
\subsection{Wyznaczanie transformaty Fouriera z definicji}
...
%		Integration theorem
\subsection{Wykorzystanie twierdzeń do obliczeń transformaty Fouriera}
...
\inputTask[Debug]{zadKW031.tex}
%	Calculating energy of the signal from its Fourier transform. The Parseval's theorem
\subsection{Obliczenia energii sygnału za pomocą transformaty Fouriera. Twierdzenie Parsevala}
...
\section{Przetwarzanie sygnałów za pomocą układów LTI}
...
\subsection{Obliczanie splotu ze wzoru}
