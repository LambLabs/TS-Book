...
\inputTask[Debug]{zadKW027-ENG.tex} %(1/(1-t^2)) - duality, by definition
...
\inputTask[Debug]{zadTG005-ENG.tex} % triangle - intergate x1, linearity, scaling, shift in time
\inputTask[Debug]{zadTG006-ENG.tex} % triangle - intergate x2, linearity, Dirac sampling
