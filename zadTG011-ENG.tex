...
\TT{Transformatę sygnału wyjściowego, czyli $Y(\jmath \omega)=U(\jmath \omega) \cdot H(\jmath \omega)$ wyznaczymy graficznie, W tym celu na wykresie transmitancji $H(\jmath \omega)$ dodamy transformatę $U(\jmath \omega)$:}{The Fourier transform of the output signal $Y(\jmath \omega)=U(\jmath \omega) \cdot H(\jmath \omega)$, we will derive graphically. Firstly, we draw the $U(\jmath \omega)$ on the $H(\jmath \omega)$ graph:}
