...
\TT{Analogicznie wyznaczmy wzpółczynnik $F_0$:}{Similarly, we may calculate $G_0$ coefficient:}
...
\TT{Analogicznie wyznaczmy wzpółczynnik $F_2$:}{Similarly, we may calculate $G_2$ coefficient:}
