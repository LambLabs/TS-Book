...
\TT{Oblicz wartość średnią okresowego sygnału $f(t)=A\cdot cos^4\left(\omega_0 \cdot t\right)$ przedstawionego na rysunku:}{Calculate the mean value of the following periodic signal $f(t)=A\cdot cos^4\left(\omega_0 \cdot t\right)$:}
...
\TT{Podstawiamy do wzoru na wartość średnią wzór naszej funkcji dla zakresu $t \in \left( -\frac{\pi}{2\cdot\omega_0}; \frac{\pi}{2\cdot\omega_0}\right)$:}{Compute mean value for period $t \in \left( -\frac{\pi}{2\cdot\omega_0}; \frac{\pi}{2\cdot\omega_0}\right)$:}
...
\TT{Średnia wartość sygnału wynosi $\frac{3}{8} \cdot A$.}{The mean value equals to $\frac{3}{8} \cdot A$.}
\end{task}