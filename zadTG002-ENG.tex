...
\TT{Transformata sygnału $f(t)=A\cdot\Pi(\frac{t}{\tau})$ to $F(\jmath \omega)=\frac{A}{ a + \jmath \cdot \omega}$.}{The Fourier transform of the $f(t)=A\cdot\Pi(\frac{t}{\tau})$ is equal to $F(\jmath \omega)=\frac{A}{ a + \jmath \cdot \omega}$.}
