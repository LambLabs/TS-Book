\begin{task}
\TT{Oblicz energię sygnału $f(t)$ przedstawionego na rysunku:}{Compute energy of $f(t)$ signal given below:} 
...
\TT{Energię sygnału nieokresowego wyznaczamy ze wzoru:}{Total energy of a non-periodic signal (or in short - signal energy) is defined by:}

\begin{equation}
E=\lim_{\tau \rightarrow \infty}\int_{-\frac{\tau}{2}}^{\frac{\tau}{2}}\left|f(t)\right|^2 \cdot dt
\end{equation}

\TT{Podstawiamy do wzoru na enargie wzór naszej funkcji}{For the given signal we get}
...
\TT{Energia sygnału wynosi $\frac{A^2}{a}$.}{Energy equals to $\frac{A^2}{a}$.}
\end{task}
