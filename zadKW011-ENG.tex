...
\TT{W pierwszej kolejności należy opisać sygnał za pomocą wzoru:}{Periodic signal $f(t)$, as a piecewise function assuming period $t \in \left(0;T\right)$ is given by:}
...
\TT{Wartość współczynnika $a_0$ wynosi $\frac{A}{\pi}$}{The $a_0$ coefficient equals $\frac{A}{\pi}$.}
...
\TT{Wartość współczynnika $a_k$ wynosi $\frac{A}{\pi} \cdot \frac{1 + cos\left(k\cdot\pi \right)}{1-k^2}$ dla $k \neq 1$}{The $a_k$ coefficients equal to $\frac{A}{\pi} \cdot \frac{1 + cos\left(k\cdot\pi \right)}{1-k^2}$ for $k \neq 1$.}

\TT{Współczynnik $a_k$ dla $k=1$ musimy wyznaczyć raz jeszcze, tak więc wyznaczmy go wprost z definicji $a_1$:}{We have to calculate $a_k$ for $k=1$ directly by definition:}
...
\TT{Wartość współczynnika $a_1$ wynosi $0$}{The $a_1$ coefficient equal to $0$.}
...
\TT{Wartość współczynnika $b_k$ wynosi $0$ dla $k \neq 1$}{The $b_k$ coefficients equal to $0$ for $k \neq 1$.}

\TT{Współczynnik $b_k$ dla $k=1$ musimy wyznaczyć raz jeszcze, tak więc wyznaczmy go wprost z definicji $b_1$:}{We have to calculate $b_k$ for $k=1$ directly by definition:}
...
\TT{Wartość współczynnika $b_1$ wynosi $\frac{A}{2}$}{The $b_1$ coefficient equal to $\frac{A}{2}$.}
