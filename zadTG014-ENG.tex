\begin{task}
\TT{Wyznacz udział mocy podstawowej (pierwszej) harmonicznej w całkowitej mocy okresowego sygnału $f(t)$ przedstawionego na rysunku:}{Compute the percentage contribution of the fundamental frequency in the total power of the periodic square signal shown in the figure below:} 
...
\TT{Teraz można wyznaczyć udział mocy podstawowej (pierwszej) harmonicznej w całkowitej mocy okresowego sygnału $f(t)$:}{Finally, the percentage contribution of the fundamental frequency in the total power of the $f(t)$ signal is equal to:}
