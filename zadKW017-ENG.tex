\begin{task}
\TT{Oblicz moc sygnału okresowego $f(t)=A\cdot sin^2\left(\omega_0 \cdot t\right)$ przedstawionego na rysunku.}{Calculate the average power for the periodic signal $f(t)=A\cdot sin^2\left(\omega_0 \cdot t\right)$ given below.}
...
\TT{Moc sygnału równa się $\frac{3 \cdot A^2}{8}$.}{The average power equals to $\frac{3 \cdot A^2}{8}$.}
\end{task}