...
&=\begin{Bmatrix}
arg\left(a + \jmath \cdot b\right) = arctg(\frac{b}{a})\\
\end{Bmatrix}\\
&=arctg\left(\frac{0}{\omega_0}\right) - arctg\left(\frac{2\cdot a \cdot \omega}{\omega_0^2-\omega^2+a^2}\right)\\
&=arctg\left(0\right) - arctg\left(\frac{2\cdot a \cdot \omega}{\omega_0^2-\omega^2+a^2}\right)\\
&=0 - arctg\left(\frac{2\cdot a \cdot \omega}{\omega_0^2-\omega^2+a^2}\right)\\
&=- arctg\left(\frac{2\cdot a \cdot \omega}{\omega_0^2-\omega^2+a^2}\right)\\
\end{align*}
